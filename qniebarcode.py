...
SCRIPT_VERSION = "V6.1-fixed (standalone catalogue + barcode-poisoning fixes)"
...
INPUT_SHEET  = 0
OUTPUT_FILE  = OUTPUT_DIR + r"\taupdatedqnie.xlsx"

NAME_COL    = "material_name"   # customer-side row name column
BRAND_COL   = "brand"           # customer-side brand column
CATEGORY_COL = "lulu_category"  # unused on customer side (kept for compat)
...
def main():
    ...
    # matched row from the final, fully-taught state.
